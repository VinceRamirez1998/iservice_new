...
<x-filament::page>
    ...
    <div class="prose max-w-full bg-white dark:bg-gray-800 text-black dark:text-white p-6 rounded-lg">
        <form wire:submit.prevent="submit" class="space-y-4">
            <div>
                <label for="name" class="block text-md text font-medium">Name</label>
            ...
            <div>
                <label for="email" class="block text-md text font-medium">Email</label>
            ...
            <div>
                <label for="phone" class="block text-md text font-medium">Phone</label>
            ...
            <div>
                <label for="password" class="block text-md text font-medium">New Password</label>
